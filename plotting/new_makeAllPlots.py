...
HISTFILE_NAME = "processedHists_2024-12-05"
OUTFILE_NAME = "plots_2024-12-05"

HISTDIR_NAME = "/exp/minerva/data/users/finer/MATAna/2024-11_development"
histFileLocation = "{0}/{1}.root".format(HISTDIR_NAME,HISTFILE_NAME)

histFile = ROOT.TFile(histFileLocation)

PLOTDIR_ROOT = "/exp/minerva/data/users/finer/MATAna/2024-11_development/plots"
...
## for pretty formatting, used below
dummy = ROOT.TGraph()  # Create a dummy object
dummy.SetMarkerStyle(0)  # Make it invisible
