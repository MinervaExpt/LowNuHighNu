...
##       if systematicUniverseClass == 'Flux' and self.systematicUniverses['CV'][0].UseNuEConstraint():
##         PlotUtils.flux_reweighter(self.systematicUniverses['CV'][0].GetPlaylist(),self.systematicUniverses['CV'][0].GetAnalysisNuPDG(),True,self.systematicUniverses['CV'][0].GetNFluxUniverses()).AddFluxErrorBand(self.hist)
